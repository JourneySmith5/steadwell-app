...
import { acceptInvitation, type SetPasswordState } from "./actions";
  ...
  return (
    <main className="flex-1 flex items-center justify-center px-6">
      <Card className="w-full max-w-sm">
        <PageHeader title="Set Up Your Account" subtitle="Create a password to secure your Steadwell account." />
